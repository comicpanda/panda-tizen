...
var successCallback = function() {
	...
	document.getElementById("body").innerHTML = '<iframe sandbox="allow-scripts allow-forms" src="http://m.tapastic.com" align="center" width="100%" height="100%"  frameborder=no scrolling="yes" id="pandaFrame"></iframe>';
